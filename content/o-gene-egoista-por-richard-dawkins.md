...
description:
author: Vítor Marçal
created_at: 2025-11-20T17:54:00
is_post: true
tags:
  - livros
  - portugues
related:
  - "[[leituras-de-2024]]"
  - "[[tags/portugues]]"
image: /img/o-gene-egoista-por-richard-dawkins.jpg
language: pt
feedback:
  - gostei
book_author:
...
format:
  - digital
is_book: true
quote: A primeira seleção natural se deu simplesmente pela seleção das formas estáveis e a rejeição das instáveis. Não há mistério algum. Por definição, tinha de acontecer assim.
page_number: 544
publisher:
...
genre:
  - ciência
dominant_color: "#106443"
---

![O gene egoístai](img/o-gene-egoista-por-richard-dawkins.jpg)
...
Uma molécula A com a sequência
`X – Y – Z – X – W – Y`
...
Basta uma única molécula com essa propriedade surgir por acaso. A partir dela, a cadeia de eventos é automática:
replicação → mutações → competição → evolução.
